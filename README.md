...
1. **GitHub Repository:** ముందుగా [GitHub](https://github.com/) లో ఒక కొత్త రిపోజిటరీని సృష్టించండి.
2. **Terminal Commands:** మీ ప్రాజెక్ట్ ఫోల్డర్‌లో టెర్మినల్ ఓపెన్ చేసి ఈ క్రింది కమాండ్స్ టైప్ చేయండి:
   ```bash
   git init
   git add .

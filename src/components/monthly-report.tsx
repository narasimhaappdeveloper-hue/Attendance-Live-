    ...
    <div className="space-y-6">
      ...
      <Card className="border border-border/80 shadow-md">
        <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0 px-4 sm:px-6">
          <div className="w-full">
            ...
            <CardDescription className="text-xs sm:text-sm mt-1">
              తేదీ బాక్స్‌పై క్లిక్ చేసి హాజరు మార్పులు చేయవచ్చు (కుడివైపుకి స్క్రోల్ చేయండి).
            </CardDescription>
          </div>
        ...
        <CardContent className="p-0 sm:p-4">
          {/* క్లియర్ స్క్రోలింగ్ బాక్స్ */}
          <div className="w-full overflow-x-auto border-t sm:border rounded-none sm:rounded-xl shadow-inner scrollbar-thin">
            {/* టేబుల్ వెడల్పు 1500px కి పెంచబడింది */}
            <Table className="min-w-[1500px] w-full border-collapse">
              <TableHeader>
                <TableRow className="bg-slate-100 text-xs text-slate-800">
                  <TableHead className="sticky left-0 bg-slate-100 z-30 min-w-[160px] p-3 font-bold border-r shadow-[2px_0_5px_rgba(0,0,0,0.06)]">
                    Employee Name
                  </TableHead>
                  ...
                  {daysInMonth.map(day => {
                    ...
                    return (
                      <TableHead 
                        key={day.toISOString()} 
                        className={`text-center min-w-[50px] border-l px-1 py-2 ${
                          isSun ? 'bg-red-100/70 text-red-700 font-extrabold' : 
                          isSat ? 'bg-amber-100/70 text-amber-700 font-bold' : 'text-slate-700'
                        }`}
                      >
                  ...
                  <TableHead className="text-center font-bold px-3 min-w-[45px] text-green-700 bg-green-50 border-l border-r">P</TableHead>
                  <TableHead className="text-center font-bold px-3 min-w-[45px] text-red-700 bg-red-50 border-r">A</TableHead>
                  <TableHead className="text-center font-bold px-3 min-w-[50px] text-teal-700 bg-teal-50 border-r">C-off</TableHead>
                  <TableHead className="text-center font-bold px-3 min-w-[50px] text-red-600 bg-slate-50 border-r">Late</TableHead>
                  <TableHead className="text-center font-bold px-3 min-w-[55px] bg-primary/10 text-primary border-r">Paid</TableHead>
                  <TableHead className="sticky right-0 bg-primary/10 z-30 min-w-[110px] text-primary font-bold text-center border-l shadow-[-2px_0_5px_rgba(0,0,0,0.06)]">Net Sal</TableHead>
                </TableRow>
              </TableHeader>
              ...
              <TableBody className="text-xs">
                {reportData.map(row => (
                  <TableRow key={row.id} className="hover:bg-slate-50 transition-colors">
                    <TableCell className="sticky left-0 bg-white font-semibold z-20 border-r p-3 shadow-[2px_0_5px_rgba(0,0,0,0.03)]">
                    ...
                    {row.dailyStatus.map((s, i) => {
                      ...
                      return (
                        ...
                        >
                          {/* బాక్స్ సైజ్ h-8 w-8 కి పెంచబడింది */}
                    ...
                    <TableCell className="sticky right-0 bg-white z-20 font-bold text-primary text-center border-l p-2 shadow-[-2px_0_5px_rgba(0,0,0,0.03)]">
              ...
              <TableFooter className="bg-slate-100 text-xs font-bold text-slate-900">
                <TableRow>
                  <TableCell className="sticky left-0 bg-slate-200 font-extrabold z-20 border-r p-3 shadow-[2px_0_5px_rgba(0,0,0,0.06)]">Grand Total</TableCell>
                  ...
                  <TableCell className="sticky right-0 bg-primary/20 z-20 font-black text-primary text-center border-l p-2">₹{Math.round(grandTotals.salary).toLocaleString()}</TableCell>
                </TableRow>
              </TableFooter>
            </Table>
          </div>
